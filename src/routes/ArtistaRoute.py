...
from src.controllers.ArtistaController import atualizar, cadastrar, editar, excluir, inserir, listar
...
artista_blueprint.add_url_rule("/lista/<int:nacional>", view_func=listar, methods=["GET"])
...
artista_blueprint.add_url_rule("/atualizacao/<int:id>", view_func=atualizar, methods=["POST"])
