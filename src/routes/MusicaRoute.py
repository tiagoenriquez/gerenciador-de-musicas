...
from src.controllers.MusicaController import (
    atualizar, cadastrar, cadastrar_sorteio, contar, editar, excluir, inserir, listar, sortear
)
...
musica_blueprint.add_url_rule("/lista/<int:artista_id>", view_func=listar, methods=["GET"])
...
musica_blueprint.add_url_rule("/atualizacao/<int:id>", view_func=atualizar, methods=["POST"])
