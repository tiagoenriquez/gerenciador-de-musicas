...
class MusicaSchema(Schema):
    ...
    nome = fields.Str(
        required=True,
        validate=validate.Length(min=1, max=63, error="O nome deve ter no máximo 63 caracteres."),
        error_messages={
    ...
    artista_id = fields.Int(required=True, error_messages={
        "required": "Você deve escolher um artista."
    })
